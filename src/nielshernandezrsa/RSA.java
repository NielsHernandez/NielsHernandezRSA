...
import java.io.UnsupportedEncodingException;import java.io.Writer;
...
/*nombre de clase*/
public class RSA {//inico variables auxiliaresxd
    public PrivateKey PrivateKey = null;//privada
    public PublicKey PublicKey = null;//publica
    public RSA()
    {
      //constructoremptyxd  

    }
    public void setPrivateKeyString(String key) throws NoSuchAlgorithmException, InvalidKeySpecException{//exepciones
